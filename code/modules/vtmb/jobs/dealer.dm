...
/datum/job/vamp/dealer
	...
	allowed_bloodlines = list("True Brujah", "Brujah", "Nosferatu", "Gangrel", "City Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Banu Haqim Sorcerer", "Banu Haqim Vizier", "Tzimisce", "Caitiff", "Ventrue", "Followers of Set", "Kiasyd", "Cappadocian")
