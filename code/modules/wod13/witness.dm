/obj/item/police_radio
	...
	icon_state = "radio"
	icon = 'code/modules/wod13/icons/items.dmi'
	onflooricon = 'code/modules/wod13/icons/onfloor.dmi'
...
/mob/living/carbon/proc/update_gribi_hud()
	var/image/holder = hud_list[AI_DETECT_HUD]
	var/icon/I = icon(icon, icon_state, dir)
	holder.pixel_y = I.Height() - world.icon_size
//	holder.icon_state = "gribi"
	holder.icon_state = "aura"
	if (client)
		if(a_intent == INTENT_HARM)
			holder.color = "#ff0000"
