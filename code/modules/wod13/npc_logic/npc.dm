...
/datum/socialrole
	...
	var/list/help_phrases = list("Помогите!",
																	...
																	"Стреляй!!")
	var/list/presence_phrases = list("Да... конечно. Что прикажешь?",
																	"Я здесь, чтобы служить тебе.",
																	"Все, что скажешь... я сделаю.",
																	"Твоя воля для меня закон.",
																	"Я рядом. Скажи, что нужно.",
																	"Ты можешь доверять мне.",
																	"Я помогу тебе, просто скажи.",
																	"Да... я слушаю тебя.",
...
/mob/living/carbon/human/npc/proc/Annoy(atom/source)
	...
	var/phrase
	if(presence_master == source)
		phrase = pick(socialrole.presence_phrases)
	else if(prob(50))
