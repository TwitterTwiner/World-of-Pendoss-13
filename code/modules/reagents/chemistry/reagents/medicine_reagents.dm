...
/datum/movespeed_modifier/slabost
	multiplicative_slowdown = 5

/datum/reagent/medicine/tramadolum
	name = "Ultramm"
	description = "A painkiller that allows the patient to move at full speed even when injured. Causes drowsiness and eventually unconsciousness in high doses. Overdose will cause a variety of effects, ranging from minor to lethal."
	reagent_state = LIQUID
	color = "#A9FBFB"
...
///////////////NOOTROPS & ANTIDEPRESSION////////////////////
/datum/reagent/medicine/mozgi
	name = "Антидеприсанты и ноотропы"
	description = "Восстанавливают работу мозга, создают новые нейронные связи и могут стимулировать или расслаблять."
	color = "#A0A0A0"
	metabolization_rate = 0.5 * REAGENTS_METABOLISM
