...
#undef BZ_HEAT_PENALTY
#undef BZ_RADIOACTIVITY_MODIFIER
#undef BZ_TRANSMIT_MODIFIER
...
#undef FREON_HEAT_PENALTY
#undef H2O_HEAT_PENALTY
#undef H2O_TRANSMIT_MODIFIER
#undef HEALIUM_HEAT_PENALTY
#undef HEALIUM_TRANSMIT_MODIFIER
#undef HEAT_PENALTY_THRESHOLD
#undef HYDROGEN_HEAT_PENALTY
#undef HYDROGEN_HEAT_RESISTANCE
...
#undef PLUOXIUM_HEAT_PENALTY
#undef PLUOXIUM_TRANSMIT_MODIFIER
...
#undef PROTO_NITRATE_HEAT_PENALTY
#undef PROTO_NITRATE_HEAT_RESISTANCE
#undef PROTO_NITRATE_TRANSMIT_MODIFIER
...
#undef TRITIUM_HEAT_PENALTY
#undef TRITIUM_TRANSMIT_MODIFIER
#undef WARNING_DELAY
#undef ZAUKER_HEAT_PENALTY
#undef ZAUKER_TRANSMIT_MODIFIER
