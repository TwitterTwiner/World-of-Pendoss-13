...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_CLOTHES_BURN_IMMUNE" = TRAIT_CLOTHES_BURN_IMMUNE,
		...
		"TRAIT_LETHALNIGGA" = TRAIT_LETHALNIGGA,
		"AUSPEX_TRAIT" = AUSPEX_TRAIT,
		"BEING_DIABLERIE" = BEING_DIABLERIE,
